...
THEMES: Dict[str, Dict[str, str]] = {
    "medical": {
        "name": "Cold Royal Obsidian",
        "background": "#020406",  # bg-void: OLED-safe
        "card_bg": "#0B1015",  # bg-obsidian
        "primary": "#D4AF37",  # gold-metallic
        "secondary": "#8C7B50",  # gold-muted
        "accent": "#E8DCCA",  # gold-champagne
        "success": "#00A86B",  # success-emerald
        "warning": "#D4AF37",  # gold-metallic
