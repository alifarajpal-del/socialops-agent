...
TRANSLATIONS = {
    "en": {
        ...
        "onboarding_body_3": "Point the camera at a product, scan the barcode, or upload an image for instant health assessment.",
        "start_now": "Start Now",
        ...
        "no_detection": "No product detected",
        ...
        "demo_error": "Demo seed error",
        "demo_cleared": "Demo data cleared successfully",
        "demo_regenerated": "Demo data regenerated successfully",
    ...
    "ar": {
        ...
        "onboarding_body_3": "وجّه الكاميرا نحو المنتج، أو امسح الباركود، أو ارفع صورة لتحصل على تقييم صحي سريع.",
        "start_now": "ابدأ الآن",
        ...
        "no_detection": "لم يتم اكتشاف منتج",
        "camera_not_ready": "الكاميرا غير جاهزة",
        
        # Results
        "health_score": "النقاط الصحية",
        "ingredients": "المكونات",
        "nutrition_details": "التفاصيل الغذائية",
        "warnings": "تحذيرات",
        ...
        "demo_error": "خطأ في تحميل البيانات التجريبية",
        "demo_cleared": "تم مسح البيانات التجريبية بنجاح",
        "demo_regenerated": "تمت إعادة توليد البيانات التجريبية بنجاح",
    ...
    "fr": {
        ...
        "onboarding_body_3": "Pointez la caméra vers un produit, scannez le code-barres ou téléchargez une image pour une évaluation santé instantanée.",
        ...
        "no_detection": "Aucun produit détecté",
        "camera_not_ready": "Caméra non prête",
        ...
        "demo_error": "Erreur de chargement des données de démonstration",
        "demo_cleared": "Données de démonstration effacées avec succès",
        "demo_regenerated": "Données de démonstration régénérées avec succès",
